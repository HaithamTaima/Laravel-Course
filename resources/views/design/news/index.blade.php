    ...
    <header>
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active" style="background-image: url('{{asset('design/news/img/1.jpg')}}')">
                ...
                <div class="carousel-item" style="background-image: url('{{asset('design/news/img/22.jpg')}}')">
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item" style="background-image: url('{{asset('design/news/img/1.jpg')}}')">
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-footer">
                            <a href="detailes.blade.php" class="btn btn-primary">Learn More</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mb-4">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6 portfolio-item">
                    <div class="card h-100">
                        <a href="#"><img class="card-img-top" src="{{asset('design/news/img/1.jpg')}}" alt=""></a>
                        <div class="card-body">
                            <h4 class="card-title">
                ...
                <div class="col-lg-4 col-sm-6 portfolio-item">
                    <div class="card h-100">
                        <a href="#"><img class="card-img-top" src="{{asset('design/news/img/3.jpg')}}" alt=""></a>
                        <div class="card-body">
                            <h4 class="card-title">
                ...
                <div class="col-lg-4 col-sm-6 portfolio-item">
                    <div class="card h-100">
                        <a href="#"><img class="card-img-top" src="{{asset('design/news/img/2.jpg')}}" alt=""></a>
                        <div class="card-body">
                            <h4 class="card-title">
            ...
            <div align="center"><a class="btn btn-success" href="all-news.blade.php">more news</a></div>
        </div>
    </section>
    <section >
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3  portfolio-item">
                    <div class="card h-100">
                        <a href="#"><img class="card-img-top" src="{{asset('design/news/img/s4.jpg')}}" alt=""></a>
                        <div class="card-body">
                            <h4 class="card-title">
                ...
                <div class="col-lg-3  portfolio-item">
                    <div class="card h-100">
                        <a href="#"><img class="card-img-top" src="{{asset('design/news/img/s1.jpg')}}" alt=""></a>
                        <div class="card-body">
                            <h4 class="card-title">
                                <a href="#">news title Four</a>
                            </h4>
                ...
                <div class="col-lg-3  portfolio-item">
                    <div class="card h-100">
                        <a href="#"><img class="card-img-top" src="{{asset('design/news/img/s2.jpg')}}" alt=""></a>
                        <div class="card-body">
                            <h4 class="card-title">
                ...
                <div class="col-lg-3  portfolio-item">
                    <div class="card h-100">
                        <a href="#"><img class="card-img-top" src="{{asset('design/news/img/s3.jpg')}}" alt=""></a>
                        <div class="card-body">
                            <h4 class="card-title">
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid rounded full-width" src="{{asset('design/news/img/6.jpg')}}" alt="" style="">
                </div>
            </div>
            <!-- /.row -->
