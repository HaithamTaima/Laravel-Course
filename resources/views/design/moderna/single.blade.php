                    ...
                    <div class="col-lg-8 entries">
                        ...
                        <article class="entry entry-single">
                            ...
                            <div class="entry-content">
                                ...
                                <img src="{{asset('design/moderna/assets/img/blog-post-4.jpg')}}" class="img-fluid" alt="">
                        ...
                        <div class="blog-author clearfix">
                            <img src="{{asset('design/moderna/assets/img/blog-author.jpg')}}" class="rounded-circle float-left" alt="">
                            <h4>Jane Smith</h4>
                        ...
                        <div class="blog-comments">
                            ...
                            <div id="comment-1" class="comment clearfix">
                                <img src="{{asset('design/moderna/assets/img/comments-1.jpg')}}" class="comment-img  float-left" alt="">
                            ...
                            <div id="comment-2" class="comment clearfix">
                                <img src="{{asset('design/moderna/assets/img/comments-2.jpg')}}" class="comment-img  float-left" alt="">
                                ...
                                <div id="comment-reply-1" class="comment comment-reply clearfix">
                                    <img src="{{asset('design/moderna/assets/img/comments-3.jpg')}}" class="comment-img  float-left" alt="">
                                    ...
                                    <div id="comment-reply-2" class="comment comment-reply clearfix">
                                        <img src="{{asset('design/moderna/assets/img/comments-4.jpg')}}" class="comment-img  float-left" alt="">
                            ...
                            <div id="comment-3" class="comment clearfix">
                                <img src="{{asset('design/moderna/assets/img/comments-5.jpg')}}" class="comment-img  float-left" alt="">
                            ...
                            <div id="comment-4" class="comment clearfix">
                                <img src="{{asset('design/moderna/assets/img/comments-6.jpg')}}" class="comment-img  float-left" alt="">
